...
class _ReportPageState extends State<ReportPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) setState(() { _loading = false; _error = 'Failed to load report'; });
    }
  }
          ...
          child: Column(children: [
                  ...
                  Expanded(child: Column(
                    ...
                    children: [
                      Text(AuthService.institutionName ?? 'Attendance Report',
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: d ? Colors.white : AppTheme.textPrimary)),
                      const SizedBox(height: 2),
                      Text('Monthly Attendance Summary',
                          style: TextStyle(fontSize: 13, color: AppTheme.greyShade(context, 500))),
                    ],
                  )),
                ]),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [AppTheme.primary.withValues(alpha: d ? 0.06 : 0.03), AppTheme.primaryLight.withValues(alpha: d ? 0.03 : 0.01)],
                      begin: Alignment.topLeft, end: Alignment.bottomRight,
                    ),
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(color: AppTheme.primary.withValues(alpha: d ? 0.1 : 0.05)),
                  ),
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ScaleOnPress(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.chevron_left_rounded, size: 18, color: d ? Colors.white : AppTheme.textPrimary),
                      ),
                    ),
                    Padding(
                    ...
                    ScaleOnPress(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppTheme.cardColor(context),
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: _isCurrent ? AppTheme.greyShade(context, 100) : AppTheme.greyShade(context, 200)),
                        ),
                        child: Icon(Icons.chevron_right_rounded, size: 18, color: _isCurrent ? AppTheme.greyShade(context, 300) : (d ? Colors.white : AppTheme.textPrimary)),
                      ),
                    ),
                    const Spacer(),
                    ScaleOnPress(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: AppTheme.accent.withValues(alpha: d ? 0.2 : 0.1), borderRadius: BorderRadius.circular(10)),
                        child: Icon(Icons.download_rounded, color: AppTheme.accent, size: 20),
                      ),
                    ),
                    ...
                    ScaleOnPress(
                      ...
                      child: Container(
                        padding: const EdgeInsets.all(8),
                        decoration: BoxDecoration(color: AppTheme.danger.withValues(alpha: d ? 0.2 : 0.1), borderRadius: BorderRadius.circular(10)),
                        child: _exporting
                            ? SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 2, color: AppTheme.danger))
            ...
            if (_report != null && _report!.report.isNotEmpty)
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [AppTheme.primary.withValues(alpha: d ? 0.15 : 0.06), AppTheme.primaryLight.withValues(alpha: d ? 0.05 : 0.03)],
                      begin: Alignment.topLeft, end: Alignment.bottomRight),
          ...
          child: _loading
              ...
              : _error != null
                  ...
                  : _report == null || _report!.report.isEmpty
                      ...
                      title: AppStrings.get('no_report_data'),
                      subtitle: AppStrings.get('mark_for_month').replaceAll('{month}', _months[_month - 1]),
                    ))
                  : ListView(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text('STUDENT DETAILS',
                              style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppTheme.greyShade(context, 500), letterSpacing: 1)),
                        ),
                                    ...
                                    child: Column(children: [
                                      Row(children: [
                                        ...
                                        Expanded(child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(r.name, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: d ? Colors.white : AppTheme.textPrimary)),
                                            ...
                                            Row(children: [
                                              ...
                                              const SizedBox(width: 8),
                                              _statBadge('${r.total}', 'Total', AppTheme.greyShade(context, 500)),
                                            ]),
                                          ],
                                        )),
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.circular(14),
                                            border: Border.all(color: color.withValues(alpha: d ? 0.3 : 0.2)),
                                          ),
  ...
  Widget _divider(bool d) {
    return Container(width: 1, height: 40, color: AppTheme.greyShade(context, d ? 300 : 200));
  }
  ...
  Widget _overviewItem(IconData icon, String value, String label, Color color) {
    return Column(children: [
      ...
      Text(label, style: TextStyle(fontSize: 11, color: AppTheme.greyShade(context, 500), fontWeight: FontWeight.w600)),
    ]);
  }
  ...
  void _exportCsv() async {
    if (_report == null || _report!.report.isEmpty) { AppTheme.showSnack(context, AppStrings.get('no_data_to_export'), isError: true); return; }
    try {
